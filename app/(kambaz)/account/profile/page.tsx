      ...
      {profile && (
        <div>
          ...
          <div className="mb-3">
            ...
            <input className="form-control" id="wd-password"
                   type="password" defaultValue={profile.password}
          ...
          <div className="mb-3">
            ...
            <input className="form-control" id="wd-dob"
                   type="date" defaultValue={profile.dob}
                   onChange={(e) => setProfile({ ...profile, dob: e.target.value })} />
          </div>
          <div className="mb-3">
            <label htmlFor="wd-email" className="form-label">Email</label>
            <input className="form-control" id="wd-email"
